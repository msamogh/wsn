...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x2b787f573cf8, const void *arg_0x2b787f572020);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x2b787f5f3618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x2b787f833020), 
int (*key_eq_fn)(void *arg_0x2b787f833798, void *arg_0x2b787f833a38));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x2b787fa42610, int arg_0x2b787fa42878);
static double RandomUniform(void );
...
#line 65
      sim_log_debug(143U, "Info", "Message from %d received by %d", __nesc_ntoh_uint16(btrpkt->nodeid.nxdata), TOS_NODE_ID);
    }
  return msg;
}
...
# 78 "../../tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x2b787fd1d5f8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2b787fd1d5f8) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x2b787fd1d5f8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "../../tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x2b787fd1c1a0, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x2b787fd1c1a0, msg, payload, len);
#line 78
...
# 110 "../../tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x2b787fd1e408, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x2b787fd1e408, msg, error);
#line 110
}
#line 110
...
# 100 "../../tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x2b787fff3e18, message_t * msg, error_t error){
#line 100
  switch (arg_0x2b787fff3e18) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x2b787fff3e18, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "../../tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x2b787fb53108){
#line 75
  switch (arg_0x2b787fb53108) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x2b787fb53108);
#line 75
      break;
#line 75
    }
...
#line 53
# 80 "../../tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x2b787fff1020, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x2b787fff1020, addr, msg, len);
#line 80
...
# 83 "../../tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x2b78803262f8){
#line 83
  switch (arg_0x2b78803262f8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x2b78803262f8);
#line 83
      break;
#line 83
    }
